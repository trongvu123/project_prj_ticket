...
public class HomeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Days day = daysDAO.getDay(daysID);
        Showtimes showtimes = seatDAo.getShowtimes(showtimeID);
        Cinema cinema = cinemaDAO.getCinema(cinemaID);
        listShowtimes  = showtimeDAO.getAllShowtimes(daysID);
        //
//        session.setAttribute("movie", movie);
//        session.setAttribute("day", day);
//        session.setAttribute("showtime", showtimes);
////        session.setAttribute("cinema", cinema);
//        session.setAttribute("listShowtime", listShowtimes);
        //
